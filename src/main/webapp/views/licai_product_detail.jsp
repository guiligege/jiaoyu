                      ...
                      <div calss="info_wenzi" style="position: relative;">
                        ...
                        <div class="span6">
                          <dl class="dl-horizontal">
                            ...
                            <dt>参考资料：</dt>
                            <dd><span class="important"><a target="_blank" id="outtertarget" targeturl="${lcProduct.productDetailUrl}" href="javascript:linkoutter();">${lcProduct.productDetail}</a></span></dd> 
                          </dl>
                        </div>
                      </div>
                    </div>
